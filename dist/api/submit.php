...
<body style="margin:0;padding:0;background:#121212;font-family:'Helvetica Neue',Arial,sans-serif;">
  <div style="max-width:600px;margin:0 auto;background:#1A1A1A;border:1px solid #333;">
    <div style="background:linear-gradient(135deg,#F59E0B,#FBBF24,#F59E0B);padding:20px;text-align:center;">
    ...
    <div style="padding:30px;">
      <table style="width:100%;border-collapse:collapse;">
        <tr style="border-bottom:1px solid #333;">
          <td style="padding:12px;color:#F59E0B;font-weight:bold;width:120px;font-size:12px;text-transform:uppercase;">Name</td>
          <td style="padding:12px;color:#E5E5E5;font-size:16px;">{$firstName} {$lastName}</td>
        </tr>
        <tr style="border-bottom:1px solid #333;">
          <td style="padding:12px;color:#F59E0B;font-weight:bold;font-size:12px;text-transform:uppercase;">Phone</td>
          <td style="padding:12px;color:#E5E5E5;font-size:18px;font-weight:bold;"><a href="tel:{$phone}" style="color:#F59E0B;text-decoration:none;">{$phone}</a></td>
        </tr>
        <tr style="border-bottom:1px solid #333;">
          <td style="padding:12px;color:#F59E0B;font-weight:bold;font-size:12px;text-transform:uppercase;">Email</td>
          <td style="padding:12px;color:#E5E5E5;font-size:16px;"><a href="mailto:{$email}" style="color:#E5E5E5;">{$email}</a></td>
        </tr>
        <tr style="border-bottom:1px solid #333;">
          <td style="padding:12px;color:#F59E0B;font-weight:bold;font-size:12px;text-transform:uppercase;">Service</td>
          <td style="padding:12px;color:#E5E5E5;font-size:16px;">{$serviceLabel}</td>
        </tr>
        <tr style="border-bottom:1px solid #333;">
          <td style="padding:12px;color:#F59E0B;font-weight:bold;font-size:12px;text-transform:uppercase;">Submitted</td>
          <td style="padding:12px;color:#E5E5E5;font-size:14px;">{$timestamp}</td>
        </tr>
        <tr style="border-bottom:1px solid #333;">
          <td style="padding:12px;color:#F59E0B;font-weight:bold;font-size:12px;text-transform:uppercase;">Page URL</td>
          <td style="padding:12px;color:#A3A3A3;font-size:12px;">{$pageUrl}</td>
        </tr>
        <tr>
          <td style="padding:12px;color:#F59E0B;font-weight:bold;font-size:12px;text-transform:uppercase;">UTM Data</td>
    ...
    <div style="padding:24px;text-align:center;background:#0B132B;border-top:1px solid #333;">
      <p style="color:#F59E0B;font-size:14px;margin:0;font-weight:bold;">Reply directly to the customer or click the phone number to call.</p>
    </div>
  </div>
</body>
</html>
...
<body style="margin:0;padding:0;background:#121212;font-family:'Helvetica Neue',Arial,sans-serif;">
  <div style="max-width:600px;margin:0 auto;background:#1A1A1A;border:1px solid #333;">
    ...
    <div style="background:linear-gradient(135deg,#F59E0B,#FBBF24,#F59E0B);padding:2px;"></div>
    ...
    <div style="padding:40px 30px;">
      ...
      <p style="color:#E5E5E5;font-size:16px;line-height:1.6;margin:0 0 24px;">
        We've received your request for <strong style="color:#F59E0B;">{$serviceLabel}</strong>. At {$businessName}, we take your home's safety seriously.
      </p>

      <div style="background:rgba(245,158,11,0.05);border:1px solid rgba(245,158,11,0.2);border-radius:12px;padding:24px;margin:24px 0;">
        <h3 style="color:#F59E0B;font-size:14px;text-transform:uppercase;letter-spacing:2px;margin:0 0 16px;font-weight:bold;">What Happens Next</h3>
        <table style="width:100%;border-collapse:separate;border-spacing:0 12px;">
          <tr>
            <td style="width:24px;vertical-align:top;color:#F59E0B;font-size:16px;">✓</td>
          ...
          <tr>
            <td style="width:24px;vertical-align:top;color:#F59E0B;font-size:16px;">📞</td>
            <td style="color:#E5E5E5;font-size:14px;padding-left:12px;"><strong>Expert Callback:</strong> A team member will call you within <strong style="color:#F59E0B;">2 hours</strong> to confirm scheduling.</td>
          </tr>
          <tr>
            <td style="width:24px;vertical-align:top;color:#F59E0B;font-size:16px;">🏠</td>
      ...
      <div style="text-align:center;margin:32px 0;">
        ...
        <a href="tel:{$businessPhone}" style="display:inline-block;background:linear-gradient(135deg,#F59E0B,#FBBF24,#F59E0B);color:#121212;font-weight:900;text-transform:uppercase;letter-spacing:1px;padding:18px 36px;text-decoration:none;border-radius:8px;font-size:15px;box-shadow:0 4px 15px rgba(245,158,11,0.3);">
